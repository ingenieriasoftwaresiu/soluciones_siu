 ...
 * @author jorge.correa
 */
public class PruebaNotificarVencimientoPedidos {
    ...
    public static void main(String[] args){
        ...
        String strOrdenPedido=null, strFechaAcordada=null, strFechaRecibido=null, strCelda, strCodigoNotificacion="";
        String[] strTemp=null;
        ...
        while (intContNotificaciones < strCodigosNotificaciones.length){        
            ...
            System.out.println("Procesando notificación: " + strCodigoNotificacion);
            ...
            if (notificacion != null){
                ...
                //strRutaArchivoPedidos = parametroGeneral.getRutaArchivoPedidos().trim();
                lgNumDiasNotificacion = Long.parseLong(notificacion.getDiasNotificar().toString());
                //lgNumDiasNotificacion = Long.parseLong(parametroGeneral.getNumeroDiasNotificacion().toString());

                System.out.println("strRutaArchivoPedidos: " + strRutaArchivoPedidos);
                            ...
                            if (intFila >= intFilaInicio){                        
                                ...
                                while (cellIterator.hasNext()){
                                    ...
                                    if (celda != null){
                                        ...
                                        switch(intCelda){
                                                ...
                                                case 13: 
                                                    ...
                                                    System.out.println("Fecha envío proveedor: " + strFechaEnvioProveedor);
                                                    break;
                                                case 16: 
                                                    if ((strValorCelda != null) && (!strValorCelda.trim().equals(""))){
                                    ...
                                    if ((strControl != null) && (!strControl.trim().equals(""))){
                                        ...
                                        System.out.println("strFechaRecibido: " + strFechaRecibido);
                                        ...
                                        if (strFechaRecibido == null || strFechaRecibido.equals("")){ //No se ha recibido el pedido aún, por lo tanto se puede procesar.
                                            ...
                                            System.out.println("strFechaAcordada: " + strFechaAcordada);
                                            ...
                                            if ((strFechaEnvioProveedor != null) && (strFechaAcordada != null)){
                                                ...
                                                System.out.println("strOrdenPedido: " + strOrdenPedido);
                                                System.out.println("strNombreProveedor: " + strNombreProveedor);

                                                strFechaEnvioProveedor = funcionesComunesDAO.convertirFechaLarga(strFechaEnvioProveedor);
                                                System.out.println("strFechaEnvioProveedor: " + strFechaEnvioProveedor);
                                                //strFechaAcordada = funcionesComunesDAO.aumentarDiasFecha(strFechaEnvioProveedor, intNroDiasAcordados);
                                                System.out.println("intNroDiasAcordados: " + intNroDiasAcordados);                                                     
                                                System.out.println("strFechaAcordada: " + strFechaAcordada);
                                            ...
                                            System.out.println("Fecha de recibido nula o vacía");
                                        }                                
                                    }                                 
                            }                        
                        }                                                  
