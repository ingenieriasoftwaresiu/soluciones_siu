 ...
 */
public class ProgramacionActualizarEstadoProyectosTotalProyectos {
    ...
    public void crearProgramacion(){
        ...
        try {
            ...
            new GIDaoException("Inicio la programación de la tarea ActualizarEstadoProyectosTotalProyectos");
            ...
            JobDetail jobDetail = new JobDetail("ActualizarEstadoProyectosTotalProyectosJob", scheduler.DEFAULT_GROUP, ActualizarEstadoProyectosTotalProyectos.class);
            ...
            //Trigger trigger = new CronTrigger("NotificarVencimientoProyectosTrigger", Scheduler.DEFAULT_GROUP, "0 15 10 * * ?");
             ...
             trigger.setName("tgActualizarEstadoProyectosTotalProyectos");
            ...
            //scheduler.shutdown();
             ...
             new GIDaoException("Finalizó la programación de la tarea ActualizarEstadoProyectosTotalProyectos.");

        } catch(Exception e) {
            new GIDaoException("Se generó un error al ejecutar la tarea ActualizarEstadoProyectosTotalProyectos. Variable error = " +  intError, e);
        }
    } 
}
