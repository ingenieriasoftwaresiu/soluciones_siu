 ...
 */
public class ProgramacionNotificarFechasProyectosTotalProyectos {
    ...
    public void crearProgramacion(){
        ...
        try {
            ...
            new GIDaoException("Inicio la programación de la tarea NotificarFechasProyectosTotalProyectos");
            ...
            JobDetail jobDetail = new JobDetail("NotificarFechasProyectosTotalProyectosJob", scheduler.DEFAULT_GROUP, NotificarFechasProyectosTotalProyectos.class);
            ...
            //Trigger trigger = new CronTrigger("NotificarVencimientoProyectosTrigger", Scheduler.DEFAULT_GROUP, "0 15 10 * * ?");
             Trigger trigger = TriggerUtils.makeDailyTrigger(07, 45);
             //trigger.setStartTime(new Date());
             trigger.setName("tgNotificarFechasProyectosTotalProyectos");
             trigger.setGroup("grupoTotalProyectos");
            ...
            //scheduler.shutdown();
             ...
             new GIDaoException("Finalizó la programación de la tarea NotificarFechasProyectosTotalProyectos.");

        } catch(Exception e) {
            new GIDaoException("Se generó un error al ejecutar la tarea NotificarFechasProyectosTotalProyectos. Variable error = " +  intError, e);
        }
    } 
}
